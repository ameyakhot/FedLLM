...
logging.info("Working on dataset: research papers dataset")

with open('pubmed.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
logging.info("Begin research client training...")
...
# saving the model
model_path = "../../models/edge_model_scientific_papers.pth"
...
logging.info("Research trial generation")
